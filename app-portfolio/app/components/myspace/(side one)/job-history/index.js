...
export const NockOps = [
    {
        id: "2",
        job_title: "Front End Developer",
        job_description:
            "Created a front end based on the needs of an AI Content Engine. Created an app that could be replicated and automated so that multiple different websites/blogs could be created by switching out the Database. Tech Stack was Javascript using Next.js for the framework with a Python and DynamoDB backend.",
