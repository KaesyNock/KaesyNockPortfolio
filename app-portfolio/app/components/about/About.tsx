			...
			<div>
				...
				<div className="ml-10 mt-5">
					<div>
						...
						<p className="mt-2 indent-5">
							...
							speaking in terms of the future while looking at a website style
						...
						<p className="mt-2 indent-5">
							...
							communicate with a computer (and when I say computer I mean in the
							most general of terms- anything capable of a binary
							stimuli/response cycle). It tends to rewire your neural pathways
							in a way that makes average communication with other humans a
						...
						<p className="mt-2 indent-5">
							...
							has given me an incredibly unique approach to this industry. My
							entire job revolved around communication, proper consultations
							(because lets not forget when you&apos;re putting chemicals that
							have a pH of 13 on someone&apos;s scalp they better know the
							risks/outcomes), and working within every aspect of human emotions
							(often times you&apos;re their therapist or the one they&apos;re
							complaining to). You tend to nail down the people skills after a
							while.
						</p>
						<p className="mt-2 indent-5">
							{" "}
				...
				<div className="ml-10 mt-5">
					...
					<p className="mt-2 indent-5">
						...
						class developers. I wanted a portfolio website that told my truth. I
						might be at the earlier stages of my career but you will never find
						an employee more dedicated, more willing to try, to grow, to want to
						learn and be better. My competition is only myself yesterday. I want
						to find a job that wants to help me grow, but that also appreciates
						having a team player.
					</p>
					<p className="mt-2 indent-5">
						I want to be part of a team that values each member. That has a
						leader whose primary goal is to build the strongest team possible. I
						want a job where I can follow my senior&apos;s advice and leadership
						so that I can improve my skills day after day. I want a team who is
						as driven and forward thinking as I am. I want to learn the cutting
						edge but I want to learn HOW we got here as an industry. I want to
						know the history of our industry. I want to learn it all. Above all
						I want to work where I can keep my head down and build clean,
						scalable, security conscious code that can make my company and my
				...
				<div className="ml-10 mt-5">
					...
					<p className="mt-2 indent-5">
						...
						the development side of the industry. I know what the conversations
						at the C-Suite Level look like, how decisions are made. I&apos;ve
						seen the designs and deployment of some of the most cutting edge
						technologies and some of the most fundamental technologies. I know
